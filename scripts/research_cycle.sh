...
DEFAULT_STRATEGIES="baseline star_guard1_soft_screen_multi_history hybrid_main_star_focus_soft_guard_screen hybrid_main_baseline_star_soft_guard_screen"
